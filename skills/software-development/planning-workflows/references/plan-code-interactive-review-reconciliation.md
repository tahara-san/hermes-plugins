...
2. Load/use `claude-i` and run the missing interactive review in tmux or the PTY fallback. Verify the Claude Code banner/status line before the substantive prompt; for Buffdemy workflows, record the default Fable 5.1/xhigh banner when shown.
