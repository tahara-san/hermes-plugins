...
- If the companion Claude Code Fable 5.1 @ xhigh effort lane is blocked by login/limits, save current-bundle blocked artifacts and leave the phase incomplete; do not let the blocked lane stop the RED/GREEN fix for a valid Codex finding.
