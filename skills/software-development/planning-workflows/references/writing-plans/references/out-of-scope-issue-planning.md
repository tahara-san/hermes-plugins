...
- Keep the conceptual gates from the Claude workflow:
  ...
  - bare interactive Codex in managed tmux with GPT-6 Astra @ xhigh and Claude Code through `claude-i`, launched before waiting on either lane for the current task
