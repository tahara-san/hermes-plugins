...
5. **Rerun every mandatory review lane against the regenerated bundle.** Launch the interactive Codex TUI and Claude Code Fable 5.1 @ xhigh effort lanes before waiting on either. Do not count stale approvals or any result from before the fixes.
